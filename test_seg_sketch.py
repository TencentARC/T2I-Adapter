...
if __name__ == '__main__':
    ...
    model_ad.load_state_dict(torch.load(opt.ckpt_ad2))
    model_ad2.load_state_dict(torch.load(opt.ckpt_ad1))
    ...
    for v_idx in range(opt.n_samples):
        with torch.no_grad():
            ...
            features_adapter1 = model_ad2(edge.to(device))
            features_adapter2 = model_ad(mask.to(device))
